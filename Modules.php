...
echo '<div class="navbar navbar-inverse bg-white">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:void(0)" onclick="check_content(\'Ajax.php?modname=miscellaneous/Portal.php\');" onmousedown="document.getElementById(\'header\').innerHTML = \'Home\'; document.getElementById(\'cframe\').src = \'Bottom.php?modcat=home\'"><img src="assets/oasis_logo.png" alt="OASIS"></a>
...
if ($_REQUEST['modname'] || $_GET['modname']) {
    ...
    //ADDED By Africa's Hope - Evan Stewart - 07-27-2021 - Need to check if this is accessible by non-admin.
        //Add modules here if a user needs access but it isn't available on the main menu
