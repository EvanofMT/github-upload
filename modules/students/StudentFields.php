    ...
    foreach ($categories_RET as $key => $value) {
        switch ($value['TITLE']) {
            ...
            case 'Credits Transferred':
                $categories_RET[$key]['TITLE'] = _creditsTransferred;
                break;
            case 'Degrees Earned':
                $categories_RET[$key]['TITLE'] = _degreesEarned;
                break;
            //END Africa's Hope changes
            default:
    ...
    if ($_REQUEST['category_id'] && $_REQUEST['category_id'] != 'new' && count($categories_RET)) {
        ...
        switch ($_REQUEST[category_id]) {
            ...
            case 3:
                ...
                break;
            case 4:
                $arr = array(enteredBy, date, comments);
            ...
            //for new Degrees Earned and Credits Transferred feature
            case 8:
                $arr = array(_creditHours,_transferredDate,_schoolName,_schoolLocation);
