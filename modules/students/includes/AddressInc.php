...
//                    javascript:void(0) data-toggle='modal' data-target='#modal_default'
			...
			//Hide Parent User Portal check box and signup. If you show this in future, also re-activate the Users > Parent menus in /modules/users/Menu.php
            /*
            echo '<div class="row">';
            if ($portal_check == '')
            ...
            //END change by Africa's Hope - 2020-12-18 - Evan Stewart
            */
...
if ($_REQUEST['nfunc'] == 'status')
{
    if ($_REQUEST['button'] == 'Select')
    {
        ...
        //this is a secondary relations list.  I'm not sure where it is used.  The primary list is defined on modules/students/ConfigInc.php
        $relation_options = array('Father' => _father,
         ...
         //'---' => '---');
         //ADDED by AFrica's Hope - Evan Stewart - 08-09-2021 - add a non-descript relation
         'Other Relation' => _otherRelation,
         '---' => '---',
