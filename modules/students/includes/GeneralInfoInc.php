...
echo '<div class="form-group"><label class="control-label col-lg-4 text-right">'._gender.'</label><div class="col-lg-8">' . SelectInput($student['GENDER'], 'students[GENDER]', '', array('Male' => _male, 'Female' => _female), 'N/A', '') . '</div></div>';
echo '</div>'; //.col-lg-6
echo '</div>'; //.row
...
echo '<div class="row">';
echo '<div class="col-lg-6">';
//ADDED by Africa's Hope - Evan Stewart //add Date Format tip after date input field
echo '<div class="form-group"><label class="control-label col-lg-4 text-right">'._dateOfBirth.'<span class="text-danger">*</span></label><div class="col-lg-8">' . DateInputAY(isset($student['BIRTHDATE']) && $student['BIRTHDATE'] != "" ? $student['BIRTHDATE'] : "", 'students[BIRTHDATE]', '2', true, 'REQUIRED') . '</div><p class="dateTip">'._dateFormatTip.'</p></div>';
echo '';
echo '</div><div class="col-lg-6">';
...
//change label from "Grade" to "Grade Level / Year"
echo '<div class="form-group"><label class="control-label col-lg-4 text-right">'._gradeLevel . ' / '._year.'<span class="text-danger">*</span></label><div class="col-lg-8">';
//END Africa's Hope addition
echo SelectInput($student['GRADE_ID'], 'values[student_enrollment][' . $student_id . '][GRADE_ID]', '', $options, '', '','','REQUIRED') . '</div></div>';
echo '</div>'; //.col-md-6
...
//ADDED by Africa's Hope - Evan Stewart //add password requirement tip
echo '<p class="passwordTip">'._passwordMustBeMinimum8CharactersWithAtleastOneSpecialCharacterAndOneNumber.'</p>';
//END Africa's Hope addition
echo '</div>';
echo '</div>';
echo '</div>'; //.col-md-6
