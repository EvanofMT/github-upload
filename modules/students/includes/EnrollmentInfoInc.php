...
//ADDED by Africa's Hope - Evan Stewart //add date format tip to start and drop date column headers
$columns = array('START_DATE' =>_startDate.' <span class="dateTip">'._dateFormatTip.'</span>',
