...
####################
    ...
    if (UserStudentID() && $_REQUEST['modfunc'] != 'choose_course' && $_REQUEST['modfunc'] != 'more_info') {
        ...
        //ADDED by Africa's Hope - Evan Stewart //add DAte Format tip to label
        echo '<div class="form-group" id="filter"><label class="control-label">'._date.'<span class="dateTip">'._dateFormatTip.'</span></label>' . PrepareDateSchedule($newformat, '_date', false, array('submit' =>true)) . '</div>';
