...
if (!$_REQUEST['modfunc']) {
    ...
    foreach ($cert_RET as $ci => $cd) {
        ...
        $cert_RET[$ci]['STAFF_CERTIFICATION_DATE'] = _makeDateCert($cd['STAFF_CERTIFICATION_DATE'], 'STAFF_CERTIFICATION_DATE', $counter_for_date, $cd['ID']);
        $counter_for_date = $counter_for_date + 1;
        $cert_RET[$ci]['STAFF_CERTIFICATION_EXPIRY_DATE'] = _makeDateCert($cd['STAFF_CERTIFICATION_EXPIRY_DATE'], 'STAFF_CERTIFICATION_EXPIRY_DATE', $counter_for_date, $cd['ID']);
    }
    ...
    'STAFF_CERTIFICATION_DATE' =>_certificationDate.' <span class="dateTip">'._dateFormatTip.'</span>',
    ...
    'STAFF_CERTIFICATION_EXPIRY_DATE' =>_certificationExpiryDate.' <span class="dateTip">'._dateFormatTip.'</span>',
    'STAFF_CERTIFICATION_DESCRIPTION' =>_certificationDescription);

    $link['add']['html'] = array('STAFF_CERTIFICATION_NAME' => _makeTextInput('', 'STAFF_CERTIFICATION_NAME'), 'STAFF_CERTIFICATION_CODE' => _makeTextInput('', 'STAFF_CERTIFICATION_CODE'), 'STAFF_CERTIFICATION_DATE' => _makeDateCert('', 'STAFF_CERTIFICATION_DATE', $counter_for_date + 1),
        ...
        'STAFF_CERTIFICATION_EXPIRY_DATE' => _makeDateCert('', 'STAFF_CERTIFICATION_EXPIRY_DATE', $counter_for_date + 2),
...
//Change function name from _makeDate to _makeDateCert.  '_makeDate' is the name of a function in the FunctionsInc.php file used by other include files. _makeDateCert is specific to CertificationInfoInc.php only
//orig - function _makeDate($value, $column = 'STAFF_CERTIFICATION_DATE', $counter = 0, $id = 'new') {
function _makeDateCert($value, $column = 'STAFF_CERTIFICATION_DATE', $counter = 0, $id = 'new') {
