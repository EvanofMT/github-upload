...
function _makeTextInput($column, $name, $size = "10", $request = 'staff') {
    global $value, $field;
...
//copied from /modules/students/includes/FunctionsInc.php
...
function _makeDate($value, $column = '', $counter = 0, $array = '') {
    if ($array == '') {
        global $THIS_RET, $table;
