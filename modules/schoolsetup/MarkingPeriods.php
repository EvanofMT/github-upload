...
//        }
        ...
        $header .= '<div class="row">';
        $header .= '<div class="col-md-6">';
        $header .= '<div class="form-group"><label class="col-md-4 control-label text-right">'._begins.' <span class="dateTip">'._dateFormatTip.'</span></label><div class="col-md-8">' . DateInputAY($RET['START_DATE'], 'tables[' . $_REQUEST['marking_period_id'] . '][START_DATE]', 1) . '</div></div>';
        $header .= '</div><div class="col-md-6">';
        $header .= '<div class="form-group"><label class="col-md-4 control-label text-right">'._ends.' <span class="dateTip">'._dateFormatTip.'</span></label><div class="col-md-8">' . DateInputAY($RET['END_DATE'], 'tables[' . $_REQUEST['marking_period_id'] . '][END_DATE]', 2) . '</div></div>';
        $header .= '</div>'; //.col-md-6
        $header .= '</div>'; //.row
        ...
        $header .= '<div class="row">';
        $header .= '<div class="col-md-6">';
        $header.= '<div class="form-group"><label class="col-md-4 control-label text-right">'._gradePostingBegins.' <span class="dateTip">'._dateFormatTip.'</span></label><div class="col-md-8">' . DateInputAY($RET['POST_START_DATE'], 'tables[' . $_REQUEST['marking_period_id'] . '][POST_START_DATE]', 3) . '</div></div>';
        $header .= '</div><div class="col-md-6">';
        $header .= '<div class="form-group"><label class="col-md-4 control-label text-right">'._gradePostingEnds.' <span class="dateTip">'._dateFormatTip.'</span></label><div class="col-md-8">' . DateInputAY($RET['POST_END_DATE'], 'tables[' . $_REQUEST['marking_period_id'] . '][POST_END_DATE]', 4) . '</div></div>';
        $header .= '</div>'; //.col-md-6
        $header .= '</div>'; //.row
