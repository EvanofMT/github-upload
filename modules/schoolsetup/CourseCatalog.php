...
function CreateList($dli = '', $pli = '', $sli = '', $cli = '', $mp = '', $mp_name = '') {
    ...
    ########################################List Output Generation ####################################################
      ...
      $columns = array('SUBJECT' => ''._division.'', 'COURSE' => ''._course.'', 'MP' => ''._markingPeriod.'', 'PERIOD_TIME' => ''._time.'', 'PERIOD' => ''._period.'', 'DAYS' => ''._days.'', 'LOCATION' => ''._location.'', 'TEACHER' => ''._teacher.'');
...
function CreateExcel($dli = '', $pli = '', $sli = '', $cli = '', $mp = '', $mp_name = '') {
    ...
    $column_names = array('SUBJECT' => ''._division.'', 'COURSE' => ''._course.'', 'SHORT_NAME' => ''._className.'', 'PERIOD' => ''._period.'', 'TEACHER' => ''._teacher.'', 'LOCATION' => ''._location.'', 'DAYS' => ''._days.'', 'BEGIN_DATE' => ''._startDate.'', 'END_DATE' => ''._endDate.'');
