...
//        if (!$_REQUEST['new_school'] && file_exists($uploaded_sql[1]['VALUE']))
        ...
        if($_REQUEST['new_school']=='true')
        {
            ...
            echo '<div class="row">';
            echo '<div class="col-md-6">';
            echo "<div class=\"form-group\"><label class=\"col-md-4 control-label text-right\">"._startDate." <span class=\"dateTip\">"._dateFormatTip."</span></label><div class=\"col-md-8\">" . DateInputAY($get_this_school_date[1]['START_DATE'], '_min', 1). "</div></div>";
            echo '</div>'; //.col-md-6
            
            echo '<div class="col-md-6">';
            echo "<div class=\"form-group\"><label class=\"col-md-4 control-label text-right\">"._endDate." <span class=\"dateTip\">"._dateFormatTip."</span></label><div class=\"col-md-8\">" . DateInputAY($get_this_school_date[1]['END_DATE'], '_max', 2). "</div></div>";
            echo '</div>'; //.col-md-6
            echo '</div>'; //.row  
        }
