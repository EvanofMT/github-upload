...
//Africa's Schools don't use all of these fields.  If reactivate, unhide asterisks for required fields in the /modules/students/includes/AddressInc.php file
/*
  frmvalidator.addValidation(
  ...
  //Require a Primary Emergency Contact relationship
  frmvalidator.addValidation(
  ...
  //Require Primary Emergency Contact to have a first name
  frmvalidator.addValidation(
