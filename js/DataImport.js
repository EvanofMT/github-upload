...
function valid_mapping_course(option, this_DET)
{
    var this_button_id = this_DET.id;
...
function valid_mapping_trousers_grades(option, this_DET)
{
    var this_button_id = this_DET.id;
    ...
    for (var i = 1; i <= option; i++)
    {
        ...
        if (n == 'TROUSERS_TERM_ID')
        {
            term_id = term_id + 1;
        }
        if (n == 'TROUSERS_TERM_NAME')
        {
        ...
        if (n == 'GRADE_PERCENT')
        {
            grade_percent = grade_percent + 1;
        }
        if (n == 'CREDIT_EARNED')
        {
            credit_earned = credit_earned + 1;
        }
        if (n == 'CREDIT_ATTEMPTED')
        {
            credit_attempted = credit_attempted + 1;
        }
    }
    var error = '';
    ...
    if (term_id != 1)
    {
        if (error != '')
        {
            error = error + ', TROUSERS_TERM_ID';
        }
        else
        {
            error = 'TROUSERS_TERM_ID';
        }
    }
    if (term_name != 1)
    {
        if (error != '')
        {
            error = error + ', TROUSERS_TERM_NAME';
        }
        else
        {
            error = 'TROUSERS_TERM_NAME';
        }
    }
    if (alt_id != 1)
    {
    ...
    if (credit_attempted != 1)
    {
        if (error != '')
        {
            error = error + ', CREDIT_ATTEMPTED';
        }
        else
        {
            error = 'CREDIT_ATTEMPTED';
        }
    }
