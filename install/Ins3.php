...
//Add additional tables for OASIS needs
$myFile = "OASISDataMysqlInc.sql";
executeSQL($myFile);

//ADDED By Africa's Hope - Evan Stewart
//create Suggested Data is checkbox was selected
if(clean_param($_REQUEST['suggested_data'],PARAM_ALPHA)){
    include('SqlForOasisSuggestedDataInc.php');
}
