                ...
                <div class="panel">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="logo">
                                    <img src="assets/images/oasis_logo.png" alt="OASIS">
                                </div>
                                <?php if ($_REQUEST['mod'] != 'upgrade') { ?>
                                    <h3>OASIS Installation - Database Connection</h3>
                                <?php } else { ?>
                                    <h3>OASIS Installation - Database Connection</h3>
                                <?php } ?>
                            </div>
...
//                                fclose($fh3);
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php //ADDED by AFrica's Hope - Evan Steart 
                                                //give a non-valid username as a placeholder that will be transformed in Ins1.php for out of box setup.  This will help in training sessions with mutlitple users
                                                //ORIGINAL -- <input type="text" name="addusername" size="20" value="root" class="form-control" />
                                                //END Africa's Hope addition
                                                ?>
                                                <input type="text" name="addusername" size="20" value="default" class="form-control" required />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Admin Password</label>
                                                <?php //ADDED by AFrica's Hope - Evan Stewart 
                                                //give a non-valid password as a placeholder  that will be transformed in Ins1.php for out of box setup.  This will help in training sessions with mutlitple users
                                                //ORIGINAL -- <input type="password" name="addpassword" size="20" class="form-control" />
                                                //The value of 'placeholder' will be used to auto-set the default DB password in Ins1.php.  If user is installing with another username password combo, then the setup wizard will accept it too
                                                //END Africa's Hope addition
                                                ?>
                                                <input type="password" name="addpassword" size="20" value="placeholder" class="form-control" required />
                                            </div>
                                        </div>
                                    </div>
                ...
                <footer>
                OASIS is based on OpenSIS.  OpenSIS logo and name Copyright &copy; Open Solutions for Education, Inc. (<a href="http://www.os4ed.com">OS4ED</a>).
                </footer>
            </div>
        </section>
    </body>
