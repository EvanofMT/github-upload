            ...
            <div class="login-wrapper">
                <div class="panel">
                    <div class="panel-heading clearfix">
                        ...
                        <h3>OASIS Installation - System Requirements</h3>                 
                    </div>
                        ...
                        <div class="installation-steps-wrapper">
                            ...
                            <div class="installation-steps valign-top">
                                ...
                                if ($err == 1) {
                                    ...
                                    echo '<div class="text-success text-italic">Hurray! your system meets the requirements for OASIS installation.</div>';
                                }
                                ?>
                                <hr/>
