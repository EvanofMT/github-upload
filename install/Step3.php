            ...
            <div class="login-wrapper">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <h3>OASIS Installation - School Information</h3>
                    </div>
                            ...
                            <div class="installation-steps">
                                ...
                                <div id="step_container">
                                    ...
                                    <form name='step3' id='step3' method="post" action="Ins3.php">
                                        ...
                                        //TURN OFF Sample Data, the sample data install SQL causes the install fail --- 
                                        ...
                                        <label class='checkbox-inline'><input type='checkbox' name='suggested_data' id='suggested_data' value='insert' id='suggested_data' checked/> Install with suggested school data (this can be edited later)</label>
                                        </div>";
                                        //END Africa's Hope additions
                                        ?>
                                        <hr/>
