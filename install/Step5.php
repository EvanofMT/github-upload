                ...
                <section class="login">
                    <div class="login-wrapper">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3>OASIS Installation - Complete</h3>
                        </div>
                        <div class="panel-body">
                            <div class="installation-steps-wrapper">
                                ...
                                <div class="installation-steps">
                                    <div class="text-center"><img src="assets/images/check-clipart-animated.gif" width="80" /><h3 class="text-success">Congratulations! You have successfully upgraded OASIS</h3></div>
                                        
                                    <div class="padding-20 p-t-0 class="text-center"">
                                        <p class="text-center">' . $display_text . '</p>
                                        <div class="text-center"><br/><a href="../index.php?modfunc=logout&ins=comp" class="btn btn-success btn-lg" target="_parent">Proceed to OASIS Login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.panel-body -->
                            ...
                            <div class="installation-steps-wrapper">
                                ...
                                <div class="installation-steps">
                                    <div class="padding-20 class="text-center"">
                                        <div class="text-center"><img src="assets/images/check-clipart-animated.gif" width="80" /><h3 class="text-success">Congratulations! You have successfully installed OASIS</h3></div>
                                        ...
                                        <div class="text-center" style="padding: 10px 0;"><a href="../index.php?modfunc=logout&ins=comp" class="btn btn-success btn-lg" target="_parent">Proceed to OASIS Login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.panel-body -->
