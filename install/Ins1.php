...
*/
//ADDED by Africa's Hope - Evan Stewart - the password value of "placeholder" is auto-set in Step1.php
//this is simple way to automate the username and password for training sessions while keeping the credentials a little more scure than storing them in the user form generated in Step1.php
if($_POST["addusername"] == "default" AND $_POST["addpassword"] == "placeholder"){
    //Africa's Hope default username and password for OASIS Raspberry Pi package deployment
    $_SESSION['username'] = "peter";
    $_SESSION['password'] = "Th3r0ck"; 
} else {
    $_SESSION['username'] = $_POST["addusername"];
    $_SESSION['password'] = $_POST["addpassword"];
}
