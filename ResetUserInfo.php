                ...
                foreach ($array as $value) {
                    if ($value != "") {
                        ...
                        if (!$result) {
                            ...
                            die(db_show_error($sql, _dbExecuteFailed, mysqli_connect_error())); //was mysql_error()
                        }
                    }
                }
            } else {
                $result = $connection->query($sql) or die(db_show_error($sql, _dbExecuteFailed, mysqli_connect_error())); //was mysql_error()
            }
            break;
    }
    return $result;
...
function db_show_error($sql, $failnote, $additional = '') {
    ...
    echo "
		<TABLE CELLSPACING=10 BORDER=0>
			...
			<TD align=right></TD>
			<TD>OASIS has encountered an error that could have resulted from any of the following:
			<br/>
			<ul>
			...
			Please take this screen shot and send it to your OASIS representative for debugging and resolution.
			</TD>
		</TR>
