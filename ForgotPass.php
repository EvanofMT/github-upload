...
function DateInputAYfp($value, $name, $counter = 1, $placeholder = _enterDate) {
...
<html lang="en">
    <head>
        ...
        <title><?php echo _oasisStudentInformationSystem; ?></title>
            ...
            <div class="login-wrapper clearfix">
                ...
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <div class="logo">
                            <img src="assets/images/oasis_logo.png" alt="openSIS" />
                        </div>
                    </div>
...
<div id="forgot_password" class="tab-pane fade in active">
 ...
 <label><?=_iAmA?></label>
    ...
    //Hide the Parent option.  OASIS is not using the Parent user account class
    /*
    ...
    */ //remove forward slash from the end of '?=_parent?/>' above, that is a PHP string
...
if ($_SESSION['err_msg'] != '')
 ...
 unset($_SESSION['err_msg']);
                                        ...
                                        <div class="form-group" id="pass_stu_dob">
                                            <?php echo DateInputAYfp('', 'password_dob', 3, _dateOfBirth) ?>
                                        </div>
                                    ...
                                    <form name="f1" id="f1" method="post" action="ResetUserInfo.php">
                                        <div class="form-group">
                                            ...
                                            <div class="radio styled-radio">
                                                ...
                                                */
                                                //remove forward slash from '?=_parent?/>' in the line above.  This is a PHP line
                                                ?>
                                            </div>                                            
                                        ...
                                        <div class="form-group" id="uname_stu_dob">
                                            <?php echo DateInputAYfp('', 'username_dob', 2, _dateOfBirth) ?>
                                        </div>                                        
